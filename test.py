...
# Run it as: 'python3 test.py (file_id of training images in S3)'
...
#Get back file_id of the newly created model.ckpt stored now in S3 folder Models/
print(res.json())